...
<html>
  ...
  <script src="https://cdn.bootcss.com/bootstrap/4.1.0/js/bootstrap.min.js"></script>
        ...
        <script>
             function zhuanlitoexcel(){
               window.location="list_scoretoexcel_1.jsp";
            }
    ...
    <body>
         ...
         <form action="${pageContext.request.contextPath}/score/importExcel2" method="post">
             <c:forEach items="${items}" var="item">
                <input type="checkbox"  name="fields" value="${item.mingcheng1}">${item.zhongwenmingcheng1}<br>
            </c:forEach>
            <input type="text" name="courseID" value="${courseID}" hidden="true" />
